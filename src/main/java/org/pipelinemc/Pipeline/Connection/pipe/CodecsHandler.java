...
import org.pipelinemc.Pipeline.Connection.protocol.PipeProtocol;
...
public final class CodecsHandler extends MessageToMessageCodec<ByteBuf, Message> {
    ...
    public CodecsHandler(PipeProtocol protocol) {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf msg, List<Object> out) throws Exception {
        ...
        if (msg.readableBytes() > 0) {
            Logger.warn("Leftover bytes (" + msg.readableBytes() + ") after decoding: " + decoded);
        }
